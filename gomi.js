...
/*  var ctx = canvas.getContext('2d');
  ...
  Bullet.prototype.draw = function(){
    ...
    context.fillRect( this.x + 2.5, this.y + 2.5, this.width, this.height, 10,10,10,10,10,10);
  };
  ...
  setInterval(function() {
    ...
    for (var i = 0; i < bulletList.length; i++) {
      ...
      if(arrows.speed && arrows.right && arrows.up && arrows.left && arrows.down && x < canvas.length - 20 && y > 0 && x > 0 && y < canvas.height - 20){
        x += 100;
        y += 100;
        x -= 100;
        y -= 100;
